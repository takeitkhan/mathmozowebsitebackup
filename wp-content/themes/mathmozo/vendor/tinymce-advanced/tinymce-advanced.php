...
//			$plugin_url = plugins_url( 'plugin-assets', __FILE__ );
			$plugin_url = get_template_directory_uri().'/vendor/tinymce-advanced/plugin-assets';
...
//		$plugin_url = plugins_url( 'block-editor', __FILE__ );
		$plugin_url = get_template_directory_uri().'/vendor/tinymce-advanced';
...
//		$plugin_url = plugins_url( 'mce/', __FILE__ );
		$plugin_url = get_template_directory_uri().'/vendor/tinymce-advanced/mce/';
